          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1"> 班级信息列表</span></td>
              </tr>
            </table></td>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" >
      <tr>
        ...
        <td width="10%" height="30" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE11">班级</span></div></td>
      ...
      <tr>
        ...
        <td height="30" bgcolor="#FFFFFF" class="STYLE11"><div align="center"><?php echo $rs['cname']?></div></td>
        
		<td height="30" bgcolor="#FFFFFF" class="STYLE11" ><div align="center" width="100"><a href="delCla.php?id=<?php echo $rs['id']?>" onclick="return confirm('are you sure?')" style="COLOR: blue">删除</a>|<a href="modCla.php?id=<?php echo $rs['id']?>" style="COLOR: blue">修改</a></div></td>
      </tr>
	  <?php }?>
    </table></td>
  </tr>
    ...
    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="67%"><table width="312" border="0" align="right" cellpadding="0" cellspacing="0">
          <tr>
            <td width="49"><div align="center"><a href="?page=1">首页</a></div>
			</td>
            <td width="49"><div align="center"><a href="?page=<?php if ($page>1) echo $page-1;else echo 1;?>">上一页</a></div>
			</td>
